    ...
    <div class="container-xxl py-1">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h2>Advocating for inclusive democratic processes, peace and security</h2>
            </div>
        </div>
    </div>
    <!-- Service End -->
            ...
            <div class="row g-0 mx-lg-0">
                ...
                <div class="col-lg-12 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        ...
                        <strong><p class="text-primary">Our History</p></strong>
                        <p style="text-align: justify">Women Defending Democracy (WODD) is a voluntary organization comprising Women Democracy Defenders from the Great Lakes region and diaspora. We advocate for inclusive democratic processes, peace, and security.</p>
