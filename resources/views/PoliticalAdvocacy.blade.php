@include('layouts.header')
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Political Advocacy</h1>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container-xxl pt-1">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="mb-4">Political Advocacy</h1>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12" data-wow-delay="0.1s">
                    <div class="rounded overflow-hidden">
                        {{-- <img class="img-fluid demoInfo" src="/assets/img/img-600x400-3.jpg" alt="">
